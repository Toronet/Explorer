$(function () {
    ...
    $('#previouslink').attr("href", "txs_espees.html?numrecords=" + recordsperpage + "&start=" + previoustran);
    $('#nextlink').attr("href", "txs_espees.html?numrecords=" + recordsperpage + "&start=" + nexttran);
    $('#previouslinkb').attr("href", "txs_espees.html?numrecords=" + recordsperpage + "&start=" + previoustran);
    $('#nextlinkb').attr("href", "txs_espees.html?numrecords=" + recordsperpage + "&start=" + nexttran);
...
function getData() {
    ...
    var request1 = {}
    request1["op"] = "gettransactions_espees";
    request1["params"] = [];
        ...
        (data1) => {
            ...
            if (data1.result) {
				...
				**/
				...
				{
					$("#txtable").find('tbody').empty();
					$("#txtable").find('tbody').append("<tr><td align=left colspan=6>There are currently no ESPEES transactions</td></tr>");				
				}
