$(function () {
    ...
    $('#previouslink').attr("href", "txs_zars.html?numrecords=" + recordsperpage + "&start=" + previoustran);
    $('#nextlink').attr("href", "txs_zars.html?numrecords=" + recordsperpage + "&start=" + nexttran);
    $('#previouslinkb').attr("href", "txs_zars.html?numrecords=" + recordsperpage + "&start=" + previoustran);
    $('#nextlinkb').attr("href", "txs_zars.html?numrecords=" + recordsperpage + "&start=" + nexttran);
...
function getData() {
    ...
    var request1 = {}
    request1["op"] = "gettransactions_zar";
    request1["params"] = [];
